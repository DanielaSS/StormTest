...
public class PrintSignalBolt  extends BaseRichBolt {
    ...
    public void execute(Tuple input) {
        ...
        try {
            ...
            output = new BufferedWriter(new FileWriter("/home/"+input.getString(0)+".out", true));
            LOG.info("PrintSignal .______________________________________________________."+input.getString(1));
            //Agregamos el valor de la senal procesada
            int [] temp=(int[]) input.getValue(1);
